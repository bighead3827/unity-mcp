...
|------|------|----------|-------------|
| `path` | `str` | ✅ | Path under Assets/ to create the script at, e.g., 'Assets/Scripts/My.cs' |
| `contents` | `str` | ✅ | Contents of the script to create (plain text C# code). The server handles Base64 encoding. |
